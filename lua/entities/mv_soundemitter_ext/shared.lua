...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Bool",	7,	"UseScriptPitch",	{ KeyName = "sndscriptpitch", Edit = { type = "Bool",	order = 7, title = t.."usescriptpitch" } })
	self:NetworkVar( "Bool",	8,	"NoStopToggle",		{ KeyName = "nostoptoggle",	  Edit = { type = "Bool",	order = 7, title = t.."nostoptoggle" } })
	...
	self:NetworkVar( "Float",	5,	"SoundLevel" )
	self:NetworkVar( "Int",		6,	"DSP",				{ KeyName = "DSP", 			  Edit = { type = "Int", 	order = 4, title = "DSP", min = 0, max = 133 } } )
